  ...
  if(milestoneRequest.readyState == 4) {
    ...
    try {
      ...
      for(i in sdkmilestones) {
	    if(sdkmilestones[i] == "---" || sdkmilestones[i] == "Future" || sdkmilestones[i] > 1.0)
      ...
      for(i in milestones) {
        ...
        if(milestones[i].split("1.")[1] < 7) {
          option.setAttribute("class", "obsolete");
        } else {
          var myrule = '#bugtable[filtermilestone="' + 
                       milestones[i] + '"] tbody tr:not([milestone~="' +
...
document.getElementById("resetFilter")
        .addEventListener("click", function(e) {
            ...
            document.getElementById("bugtable").removeAttribute("filtermilestone");
